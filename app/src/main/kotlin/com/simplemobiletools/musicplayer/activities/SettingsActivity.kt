...
class SettingsActivity : SimpleActivity() {
    ...
    private fun setupRequireAudioFocus() {
        settings_require_audio_focus.isChecked = config.audioFocusEnabled
        settings_require_audio_focus_holder.setOnClickListener {
            settings_require_audio_focus.toggle()
            config.audioFocusEnabled = settings_require_audio_focus.isChecked
        }
    }
}
